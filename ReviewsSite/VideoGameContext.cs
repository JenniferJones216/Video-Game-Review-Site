    ...
    public class VideoGameContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Review>().HasData(
                ...
                new Review() { Id = 6, Username = "Bort", Usercomment = "I would die for Kim Kitsuragi" },
                new Review() { Id = 7, Username = "anarky", Usercomment = "I don't think there are many,if any, other games where you can play as a communist,schizophrenic, disco, cop." },
                new Review() { Id = 8, Username = "Denky", Usercomment = "Disco Elysium is genius, one of the best games ever. Must play this if you like good writing and tabletop RPGs" },
                ...
                new Review() { Id = 9, Username = "MammadYmir", Usercomment = "A MUST-PLAY to fans of pretty much any genre of games. Anything more I'd wouldnt even begin to describe the magnificence of the gameplay, the environment, and all of the other elements" },
                new Review() { Id = 10, Username = "Vox", Usercomment = "A mix between Skyrim & the newer Hitman games. Underrated masterpiece" },
                new Review() { Id = 11, Username = "Wracky <3 Y", Usercomment = "If this game was a guy, I'll marry him." },
                new Review() { Id = 3, Rating = 3.8, Username = "Barack Obama", Usercomment = "there was no cake :((((((((((((((((((((((((((((((((((((", VideoGameId = 3 },
                new Review() { Id = 12, Username = "VIC", Usercomment = "very neat! very cool! enjoyed every second despite the immense stress GLaDOS caused me in those last couple levels." },
                new Review() { Id = 13, Username = "AshDragon", Usercomment = "The cake is a lieee!!!!!" },
                new Review() { Id = 14, Username = "Stellaris", Usercomment = "Great game good puzzle solving and challenging" },
                ...
                new Review() { Id = 15, Username = "YT_KameHameNah", Usercomment = "Fantastic puzzle game with a philosophy minigame hidden within" },
                new Review() { Id = 16, Username = "Sloppy Joe", Usercomment = "The Talos principle is a very good puzzle game. The gameplay is okay but the story is amazing. It's both challenging and engaging" },
                new Review() { Id = 17, Username = "Jacquee Mameet", Usercomment = "will make you think long and hard the next time you fail a captcha test" },
                new Review() { Id = 18, Username = "bug", Usercomment = "Good game to play when you're having an existential crisis" },
                ...
                new Review() { Id = 19, Username = "DrMiro", Usercomment = "side quests and the pretty environment keep me coming back. When you use mods the game can become a completely different game, so there's always something to check out." },
                new Review() { Id = 20, Username = "Rob N", Usercomment = "Ruined my life. Five stars." },
                new Review() { Id = 21, Username = "Pee Wee Herman", Usercomment = "All these DLC's make me feel alive"}
               );
            ...
            modelBuilder.Entity<VideoGamePlatform>().HasData(
               ...
               new VideoGamePlatform() { Id = 7, PlatformId = 1, VideoGameId = 1 },
               new VideoGamePlatform() { Id = 8, PlatformId = 1, VideoGameId = 1 },
               new VideoGamePlatform() { Id = 8, PlatformId = 2, VideoGameId = 1 },
               new VideoGamePlatform() { Id = 8, PlatformId = 3, VideoGameId = 1 },
               new VideoGamePlatform() { Id = 9, PlatformId = 1, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 9, PlatformId = 2, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 9, PlatformId = 3, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 10, PlatformId = 1, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 10, PlatformId = 2, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 10, PlatformId = 3, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 11, PlatformId = 1, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 11, PlatformId = 2, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 11, PlatformId = 3, VideoGameId = 2 },
               new VideoGamePlatform() { Id = 12, PlatformId = 1, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 12, PlatformId = 2, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 12, PlatformId = 3, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 13, PlatformId = 1, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 13, PlatformId = 2, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 13, PlatformId = 3, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 14, PlatformId = 1, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 14, PlatformId = 2, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 14, PlatformId = 3, VideoGameId = 3 },
               new VideoGamePlatform() { Id = 15, PlatformId = 1, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 15, PlatformId = 2, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 15, PlatformId = 3, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 16, PlatformId = 1, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 16, PlatformId = 2, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 16, PlatformId = 3, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 17, PlatformId = 1, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 17, PlatformId = 2, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 17, PlatformId = 3, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 18, PlatformId = 1, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 18, PlatformId = 2, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 18, PlatformId = 3, VideoGameId = 4 },
               new VideoGamePlatform() { Id = 19, PlatformId = 1, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 19, PlatformId = 2, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 19, PlatformId = 3, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 20, PlatformId = 1, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 20, PlatformId = 2, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 20, PlatformId = 3, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 21, PlatformId = 1, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 21, PlatformId = 2, VideoGameId = 5 },
               new VideoGamePlatform() { Id = 21, PlatformId = 3, VideoGameId = 5 }
               );
        }
